    ...
    <div className="container" style={{ paddingTop: 40, paddingBottom: 80 }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <h1 style={{ fontSize: '2.8rem', fontWeight: 800, color: '#0f172a', marginBottom: 12 }}>
            About SoloTrip
          </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20, marginBottom: 48 }}>
          <div style={{ background: '#ffffff', padding: 24, borderRadius: 16, border: '1px solid #e2e8f0' }}>
            ...
            <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: 6 }}>100% Vetted Stays</h3>
          ...
          <div style={{ background: '#ffffff', padding: 24, borderRadius: 16, border: '1px solid #e2e8f0' }}>
            ...
            <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: 6 }}>No Solo Alienation</h3>
            <p style={{ fontSize: '0.9rem', color: '#64748b', lineHeight: 1.5 }}>
          ...
          <div style={{ background: '#ffffff', padding: 24, borderRadius: 16, border: '1px solid #e2e8f0' }}>
            ...
            <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: 6 }}>Respect for Locals</h3>
            <p style={{ fontSize: '0.9rem', color: '#64748b', lineHeight: 1.5 }}>
        ...
        <div style={{ background: '#ffffff', borderRadius: 20, padding: 36, border: '1px solid #e2e8f0', marginBottom: 48 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              ...
              <div>
                <strong>Share Your Live Itinerary:</strong> Always ensure at least one family member or friend has access to your live GPS location and stay addresses.
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              <CheckCircle2 size={20} color="#10b981" style={{ flexShrink: 0, marginTop: 2 }} />
              <div>
                <strong>Offline Navigation:</strong> Download offline Google Maps for mountain regions where cellular connectivity can drop.
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              <CheckCircle2 size={20} color="#10b981" style={{ flexShrink: 0, marginTop: 2 }} />
              <div>
                <strong>Emergency First-Aid:</strong> Carry personal essential medications, water purification tablets for high-altitude treks, and emergency cash.
              </div>
            </div>
          </div>
        </div>
